...
const CategoryDetails = (props) => {
  ...
  const [iternational, setIternational] = useState(0);
        ...
        <main id="single-category-page">
          <div className="container">
            ...
            <div className="b-overlay-wrap position-relative">
              ...
              :
              internationArtists.map((item2, index2) => {
                  return (
                    <React.Fragment key={index2}>
                        <div className="mb-3 col-md-4 col-6">
                          <Link
                            to={`/artist/${item2.id}/${item2.name}`}
                            className="category-artist text-decoration-none"
                          >
                            <div className="artist-info">
                              <div className="artist-image">
              ...
              {/* <div className="row">
                {category && category.artists ? 
                 ( 
                  internationArtists.map((item, index2) => {
                    return (
                      <React.Fragment key={index2}>
                        <div className="mb-3 col-md-4 col-6">
                          <Link
